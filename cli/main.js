...
class RenameProject extends clipanion_1.Command {
    constructor() {
        super(...arguments);
        this.organization = clipanion_1.Option.String("--organization", { required: true });
        this.project = clipanion_1.Option.String("--project", { required: true });
    }
    async execute() {
    ...
    async renameProject() {
        try {
            ...
            const camelCaseProjectName = (0, lodash_1.camelCase)(this.project);
