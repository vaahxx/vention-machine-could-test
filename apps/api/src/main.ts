...
function configureSwagger(app: NestFastifyApplication) {
  const swaggerConfig = new DocumentBuilder().setTitle("ventionMachineCloudTest").setDescription("The ventionMachineCloudTest API description").setVersion("1.0").build()
